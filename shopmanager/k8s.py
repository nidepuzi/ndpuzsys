...
import raven
RAVEN_CONFIG = {
    'dsn': 'http://c10dc87141bf43c5a03ca5e615893669:ca2792b29a684b2ebd396107f666ffbb@sentry.nidepuzi.com/13',
...
LOGGER_HANDLERS = [
    ...
    ('dogslow', 'sentry,jsonfile'),
    ('django.request', 'sentry,jsonfile'),
    ('raven', 'sentry,jsonfile'),
