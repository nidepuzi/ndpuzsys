...
from shopback.dinghuo import permissions as perms
from shopback.dinghuo.filters import DateFieldListFilter
from shopback.dinghuo.models import OrderList, OrderDetail, ProductSkuDetail, ReturnGoods, RGDetail, \
...
from shopback.dinghuo.models import StockBatchFlowRecord
...
class OrderListAdmin(BaseModelAdmin):
    ...
    def note_name(self, obj):
        return u'<pre style="white-space: pre-wrap;word-break:break-all;width:200px;">{0}</pre>'.format(
            obj.note)
...
from shopback.dinghuo.models import DailyStatsPreview
...
from shopback.dinghuo.models import RecordGroupPoint
...
from shopback.dinghuo.models_purchase import PurchaseArrangement, PurchaseDetail, PurchaseOrder
