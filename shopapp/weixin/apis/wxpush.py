...
class WeixinPush(object):
    ...
    def push_trade_pay_notify(self, saletrade):
        ...
        if is_boutique_register_product:
            ...
            to_url = 'http://m.hongguotang.com/mama_shop/html/intro_march.html'
        else:
            footer = template.footer.decode('string_escape')
            to_url = 'http://m.hongguotang.com/mall/od.html?id=%s' % saletrade.id
    ...
    def push_refund_notify(self, salerefund, event_type):
        ...
        to_url = 'http://m.hongguotang.com/mall/refunds/details/%s' % salerefund.id
        try:
    ...
    def push_mama_invite_award(self, mama, buy_customer, amount, level_1_customer=None):
        ...
        to_url = 'https://m.hongguotang.com'
    ...
    def push_pintuan_success(self, teambuy, customer):
        ...
        to_url = 'http://m.hongguotang.com/mall/order/spell/group/{teambuy_id}?mm_linkid={mama_id}&from_page=wx_push'.format(**{
    ...
    def push_mama_clickcarry(self, clickcarry, fake=False, advertising=False):
        ...
        to_url = 'http://m.hongguotang.com/rest/v2/mama/redirect_stats_link?link_id=4'
        footer_color = '#F87217'
    ...
    def push_mama_coupon_audit(self, coupon_record):
        ...
        to_url = 'https://m.hongguotang.com/rest/v1/users/weixin_login/?next=https://m.hongguotang.com/tran_coupon/html/trancoupon.html'
        footer_color = '#F87217'
    ...
    def push_event(self, event_instance):
        ...
        if not to_url:
            ...
            login_url = 'http://m.hongguotang.com/rest/v1/users/weixin_login/?next='
