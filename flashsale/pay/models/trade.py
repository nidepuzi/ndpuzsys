...
class SaleOrder(PayBaseModel):
    ...
    def is_finishable(self):
        ...
        p=Product.objects.filter(id=self.item_id).first()
        if p.model_id:
    ...
    def confirm_sign_order(self):
        ...
        if self.status == SaleOrder.TRADE_BUYER_SIGNED:
            return
    ...
    def is_recharge_deposit(self):
        return self.is_deposit() and (self.outer_sku_id == '600' or self.outer_sku_id == '3000'
                                      ...
                                      or self.outer_sku_id == '80000' or self.outer_sku_id == '100' or self.item_id == '80880')
