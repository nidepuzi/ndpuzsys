...
APP_DOWNLOAD_URL = 'http://m.hongguotang.com/sale/promotion/appdownload/'
WEEKLY_AWARD_RULES_URL = 'http://forum.hongguotang.com/accounts/xlmm/login/?next=/topic/1263/%s/'%urllib.quote('你的铺子周奖励机制最详尽揭秘')
