...
$(document).ready(function () {
    ...
    $('.female-zone').click(function () {
        ...
        // 2016.3.30更换为跳转到商城页面
        location.href = 'http://m.hongguotang.com/nvzhuang.html?mm_linkid=' + mm_linkid_for_shop + '&ufrom=' + link_ufrom;
    ...
    $('.child-zone').click(function () {
        ...
        location.href = 'http://m.hongguotang.com/chaotong.html?mm_linkid=' + mm_linkid_for_shop + '&ufrom=' + link_ufrom;
        //nextShopPage = GLConfig.baseApiUrl + GLConfig.mama_shop;//第一页初始化
