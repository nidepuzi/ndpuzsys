...
class APPFullPushMessge(BaseModel):
    ...
    PLATFORM_CHOICES = (
        ...
        (TOPIC_XLMM, '你的铺子妈妈'),
        (TOPIC_XLMM_A_LEVEL, '你的铺子妈妈Ａ类'),
        (TOPIC_XLMM_VIP_LEVEL, '你的铺子妈妈VIP1'),
        (TOPIC_XLMM_VIP2_LEVEL, '你的铺子妈妈VIP2'),
        (TOPIC_XLMM_VIP4_LEVEL, '你的铺子妈妈VIP4'),
        (TOPIC_XLMM_VIP6_LEVEL, '你的铺子妈妈VIP6'),
        (TOPIC_XLMM_VIP8_LEVEL, '你的铺子妈妈VIP8'),
    ...
    TARGET_CHOICES = (
        ...
        (constants.TARGET_TYPE_VIP_HOME, '你的铺子妈妈/首页'),
        (constants.TARGET_TYPE_VIP_0DAY, '你的铺子妈妈/每日推送'),
        (constants.TARGET_TYPE_WEBVIEW, 'webView网页'),
        (constants.TARGET_TYPE_AT, '你的铺子论坛'),
