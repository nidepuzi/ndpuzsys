...
def index(request):
    ...
    if not valid_openid(user_openid) or not valid_openid(user_unionid):
        redirect_url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxc2848fa1e1aa94b5&redirect_uri=http://m.nidepuzi.com/sale/exam/&response_type=code&scope=snsapi_base&state=135#wechat_redirect"
